...
int main() {
    ...
    if (w1.has_value()) {
        std::cout << "w1 does have value=" << w1.value() << "\n";
        // std::cout << "w1 does have value=" << *w1 << "\n";
        std::cout << "w1 length=" << w1.value().size() << "\n";
        // std::cout << "w1 length=" << w1->size() << "\n";
    } else {
        std::cout << "w1 does not have value\n";
    }
}
